# SRE at Google: Study Notes

Complete study notes for **"Site Reliability Engineering: How Google Runs Production Systems"** by Google engineers.
...
### By Role
- **New SRE:** Start with chapters 1 → 4 → 11 → 12
- **Developer → SRE:** Start with chapters 2 → 3 → 4 → 6
- **Ops → SRE:** Start with chapters 1 → 3 → 5 → 7
...
- Topic finder (search by area)
- Full learning paths by role
...
**1 Week:** Chapters 1-3 (Day 1-2) → 4-5 (Day 3) → 6-8 (Day 4) → 9-12 (Day 5)

**1 Month:** 1 chapter per week + practice

**Self-Paced:** Choose chapters by topic or role
...
These study notes are transformative educational materials designed to help understand and apply SRE concepts.

---

**Start learning:** Pick a chapter from the list above or see [INDEX.md](./INDEX.md) for topic-based navigation.
